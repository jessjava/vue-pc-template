...
<script>
  ...
  export default {
    ...
    created() {
      ...
      const theme = localStorage.getItem('vue-theme')
      if (null !== theme) {
    ...
    methods: {
      ...
      handleSetTheme() {
        ...
        document.getElementsByTagName('body')[0].className = `vue-theme-${name}`
      ...
      handleSetDfaultTheme() {
        ...
        document
          ...
          .classList.remove(`vue-theme-${name}`)
        localStorage.removeItem('vue-theme')
